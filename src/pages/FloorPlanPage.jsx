            ...
            <div className="py-5 md:py-2">
                <div className="m-2 mb-16 md:mb-24 md:mt-10 md:mx-36 rounded-xl shadow-xl bg-[#e9e9df]">
                    <div className="flex flex-col md:flex-row p-1 md:p-8">
                        ...
                        <div className="flex flex-col md:ms-8 mx-3 md:mx-0 py-3 md:py-0">
                            <p className="text-2xl font-bold mb-3 md:mb-3 place-self-center md:place-self-start">Apartment floor plan</p>
                            { 
                            window.innerWidth <= 768 ? (
                ...
                <div className="m-2 mb-16 md:mb-24 md:mt-10 md:mx-36 rounded-xl shadow-xl bg-[#e9e9df]">
                    <div className="flex flex-col md:flex-row p-1 md:p-8">
                        ...
                        <div className="flex flex-col md:ms-8 mx-3 md:mx-0 py-3 md:py-0">
                            <p className="text-2xl font-bold mb-3 md:mb-3 place-self-center md:place-self-start">1-Bedroom Living at Its Finest</p>
                            { 
                            window.innerWidth <= 768 ? (
                ...
                <div className="m-2 mb-16 md:mb-24 md:mt-10 md:mx-36 rounded-xl shadow-xl bg-[#e9e9df]">
                    <div className="flex flex-col md:flex-row p-1 md:p-8">
                        ...
                        <div className="flex flex-col md:ms-8 mx-3 md:mx-0 py-3 md:py-0">
                            <p className="text-2xl font-bold mb-3 md:mb-3 place-self-center md:place-self-start">2-Bedroom Comfort and Style</p>
                            { 
                            window.innerWidth <= 768 ? (
                ...
                <div className="m-2 md-16 md:mb-24 md:mt-10 md:mx-36 rounded-xl shadow-xl bg-[#e9e9df]">
                    <div className="flex flex-col md:flex-row p-1 md:p-8">
                        { 
                        window.innerWidth >= 768 ? (
