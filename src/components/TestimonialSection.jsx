...
const TestimonialSection = () => {
    ...
    return (
        ...
        <div className="testimonial-section">
            <div className="flex flex-col justify-center items-center">
                <p className="text-2xl md:text-3xl font-bold">Testimonials</p>
                <p className="text-lg md:text-xl text-center">Discover what our residents have to say about Ocean View Oasis.</p>
            </div>
